...
const ListItem = ({ user, restaurant }) => {
  return (
    <StyledListItem isRestaurantOwner={user.type !== userTypes.CUSTOMER}>
      ...
      <div className="right icon-container">
        <FiEdit className="icon" size={20} color={theme.colors.darkGray} />
        <AiOutlineDelete className="icon" size={22} color={theme.colors.darkGray} />
      </div>
    </StyledListItem>
  )
}
